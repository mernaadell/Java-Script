...
var scores,roundScore,activeplayer,gameplaying,dice,prevdice,winning;
function init(){
    activeplayer=0;
roundScore=0;
scores=[0,0]
 prevdice=0
gameplaying=true;
winning=document.querySelector("#myText").value;
...
3. Add another dice to the game,
 so that there are two dices now. 
