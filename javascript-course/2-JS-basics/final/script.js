...
// var mark=prompt("enter mark's mass");
// var john=prompt("enter john's mass");
// var markHeight=prompt("enter mark's Height");
// var johnHeight=prompt("enter john's Height");
// var markBMI = mark / markHeight^2 ;
// var johnBMI = john / johnHeight^2 ;
...
var avgTeam1=(89+120+103)/3;
var avgTeam2=(116+94+123)/3;
avgTeam1>avgTeam2?console.log("team1 win "+" "+avgTeam1):console.log("team2 win "+" "+avgTeam2)
if(avgTeam1>avgTeam2){
    console.log("team1 win "+" "+avgTeam1)
}
else if(avgTeam1<avgTeam2){
    console.log("team2 win "+" "+avgTeam2)
}
else{
...
var calc={
    ...
    tips:function(){
        for(var i=0;i<this.bills.length;i++){
            ...
            this.tipsarr.push(bills[i]+bills[i]*percentage)
        }
